...
*▸ Key (String); Cardinality `one` (mandatory with default value `<empty>`); This property denotes a key of a key-value pair.

*▸ Value (String); Cardinality `one` (mandatory with default value ``); This property denotes a string value as used in a key-value pair.*/
class KeyValuePair(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 20, seq_4762) with KeyValuePairBase with StaticType[KeyValuePairEMT] {
