...
order of 0.*/
class TypeParameter(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 41, seq_4762) with TypeParameterBase with AstNode with StaticType[TypeParameterEMT] {
