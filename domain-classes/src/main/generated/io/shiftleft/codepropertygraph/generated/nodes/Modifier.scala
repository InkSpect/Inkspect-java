...
*▸ ModifierType (String); Cardinality `one` (mandatory with default value `<empty>`); The modifier type is a free-form string. The following are known modifier types:
...
order of 0.*/
class Modifier(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 30, seq_4762) with ModifierBase with AstNode with StaticType[ModifierEMT] {
