...
order of 0.*/
class AnnotationParameter(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 2, seq_4762) with AnnotationParameterBase with AstNode with StaticType[AnnotationParameterEMT] {
