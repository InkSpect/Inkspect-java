...
trait AstNodeEMT extends AnyRef with HasCodeEMT with HasColumnNumberEMT with HasLineNumberEMT with HasOffsetEMT with HasOffsetEndEMT with HasOrderEMT
...
/** Node types with this marker trait are guaranteed to have the EVIDENCE_DESCRIPTION property.
   * EMT stands for: "erased marker trait", it exists only at compile time in order to improve type safety. */
...
/** Node types with this marker trait are guaranteed to have the GENERIC_SIGNATURE property.
   * EMT stands for: "erased marker trait", it exists only at compile time in order to improve type safety. */
...
/** Node types with this marker trait are guaranteed to have the MYPROPERTY property.
   * EMT stands for: "erased marker trait", it exists only at compile time in order to improve type safety. */
