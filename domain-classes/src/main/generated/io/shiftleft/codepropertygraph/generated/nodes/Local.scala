...
trait LocalEMT extends AnyRef with AstNodeEMT with DeclarationEMT with HasClosureBindingIdEMT with HasDynamicTypeHintFullNameEMT with HasGenericSignatureEMT with HasPossibleTypesEMT with HasTypeFullNameEMT
...
class Local(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 22, seq_4762) with LocalBase with AstNode with Declaration with StaticType[LocalEMT] {
