...
order of 0.*/
class AnnotationParameterAssign(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 3, seq_4762) with AnnotationParameterAssignBase with AstNode with StaticType[AnnotationParameterAssignEMT] {
