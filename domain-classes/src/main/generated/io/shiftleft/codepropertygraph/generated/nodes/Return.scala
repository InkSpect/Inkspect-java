...
order of 0.*/
class Return(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 34, seq_4762) with ReturnBase with Expression with StaticType[ReturnEMT] {
