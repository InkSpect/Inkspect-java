...
*▸ CanonicalName (String); Cardinality `one` (mandatory with default value `<empty>`); This field holds the canonical name of a `FIELD_IDENTIFIER`. It is typically
...
order of 0.*/
class FieldIdentifier(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 13, seq_4762) with FieldIdentifierBase with Expression with StaticType[FieldIdentifierEMT] {
