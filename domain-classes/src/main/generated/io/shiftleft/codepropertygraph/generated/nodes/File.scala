...
*▸ Content (String); Cardinality `one` (mandatory with default value `<empty>`); Certain files, e.g., configuration files, may be included in the CPG as-is.
...
order of 0.*/
class File(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 14, seq_4762) with FileBase with AstNode with StaticType[FileEMT] {
