...
*▸ TypeDeclFullName (String); Cardinality `one` (mandatory with default value `<empty>`); The static type decl of a TYPE. This property is matched against the FULL_NAME
of TYPE_DECL nodes. It is required to have exactly one TYPE_DECL for each
different TYPE_DECL_FULL_NAME*/
class Type(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 38, seq_4762) with TypeBase with StaticType[TypeEMT] {
