...
order of 0.*/
class TemplateDom(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 37, seq_4762) with TemplateDomBase with Expression with StaticType[TemplateDomEMT] {
