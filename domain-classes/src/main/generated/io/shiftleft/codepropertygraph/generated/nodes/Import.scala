...
*▸ ExplicitAs (Boolean); Cardinality `ZeroOrOne` (optional); Specifies whether the IMPORTED_AS property was explicitly present in the code.
...
*▸ ImportedAs (String); Cardinality `ZeroOrOne` (optional); The identifier under which the import can be accessed in the importing context.
...
*▸ ImportedEntity (String); Cardinality `ZeroOrOne` (optional); The identifying string of the imported entity.
For a Java import like "import java.nio.ByteBuffer;" this would be "java.nio.ByteBuffer".

*▸ IsExplicit (Boolean); Cardinality `ZeroOrOne` (optional); Specifies whether this is an explicit import.
...
*▸ IsWildcard (Boolean); Cardinality `ZeroOrOne` (optional); Specifies whether this is a wildcard import.
...
order of 0.*/
class Import(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 17, seq_4762) with ImportBase with AstNode with StaticType[ImportEMT] {
