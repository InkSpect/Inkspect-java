...
*▸ ControlStructureType (String); Cardinality `one` (mandatory with default value `<empty>`); The `CONTROL_STRUCTURE_TYPE` field indicates which kind of control structure
...
class ControlStructure(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 11, seq_4762) with ControlStructureBase with Expression with StaticType[ControlStructureEMT] {
