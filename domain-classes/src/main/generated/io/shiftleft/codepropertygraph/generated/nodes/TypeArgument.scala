...
order of 0.*/
class TypeArgument(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 39, seq_4762) with TypeArgumentBase with AstNode with StaticType[TypeArgumentEMT] {
