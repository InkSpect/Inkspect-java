...
order of 0.*/
class ArrayInitializer(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 4, seq_4762) with ArrayInitializerBase with Expression with StaticType[ArrayInitializerEMT] {
