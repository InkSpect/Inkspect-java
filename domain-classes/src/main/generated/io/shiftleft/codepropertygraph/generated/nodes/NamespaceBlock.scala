...
order of 0.*/
class NamespaceBlock(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 33, seq_4762) with NamespaceBlockBase with AstNode with StaticType[NamespaceBlockEMT] {
