...
*▸ Language (String); Cardinality `one` (mandatory with default value `<empty>`); This field indicates which CPG language frontend generated the CPG.
...
*▸ Overlays (String); Cardinality `List` (many); The field contains the names of the overlays applied to this CPG, in order of their
...
*▸ Root (String); Cardinality `one` (mandatory with default value `<empty>`); The path to the root directory of the source/binary this CPG is generated from.

*▸ Version (String); Cardinality `one` (mandatory with default value `<empty>`); A version, given as a string. Used, for example, in the META_DATA node to
indicate which version of the CPG spec this CPG conforms to*/
class MetaData(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 24, seq_4762) with MetaDataBase with StaticType[MetaDataEMT] {
